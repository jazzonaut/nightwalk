...
- **C# build errors during export.** Run `dotnet build Nightwalk.csproj` locally; CI uses .NET 8 SDK from `actions/setup-dotnet@v4`. Make sure your local SDK matches.
